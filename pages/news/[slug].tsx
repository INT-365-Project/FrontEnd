    ...
    <div className="min-h-screen pl-[30px] lg:pl-[130px] pr-[20px] pt-[80px] lg:pt-[40px] lg:pr-[50px] w-full">
      ...
      <main className="min-h-screen relative w-full">
        <div className="w-full ">
          ...
          <div className="bg-white min-h-[800px] rounded-lg drop-shadow-md">
            ...
            <div className="h-[50%] w-full px-[20px] pt-[40px]">
          ...
          <div className="mt-[40px] w-full">
            ...
            <div className="bg-white h-[230px] rounded-lg relative overflow-y-auto drop-shadow-md">
            ...
            <div className="h-[15%] mt-[20px]  bg-white rounded-lg drop-shadow-md flex items-center">
              <input
